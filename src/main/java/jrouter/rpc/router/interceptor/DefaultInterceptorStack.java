 ...
 *
 */
package jrouter.rpc.router.interceptor;
...
public class DefaultInterceptorStack {
     ...
     */
    @InterceptorStack(interceptors = {ExceptionInterceptor.EXCEPTION})
    public static final String EXCEPTION_INTERCEPTOR_STACK = "exception";
