...
//        properties.defaultInterceptorStack(DefaultInterceptorStack.EXCEPTION_INTERCEPTOR_STACK);
        properties.setDefaultResultType(WebSocketResult.WEB_SOCKET);
        WEBSOCKET_SERVER_ACTION_FACTORY = new WebSocketServerActionFactory(properties);
