...
import net.jrouter.rpc.router.server.websocket.DemoServerEndpoint;
import net.jrouter.rpc.router.server.websocket.WebSocketServerActionFactoryNGTest;
...
//        final Session session = container.connectToServer(clientEndpoint, new URI(demoWebSocketURL));
        ...
        webSocketClientActionFactory = new WebSocketClientActionFactory(pool, new WebSocketClientActionFactory.Properties());
    ...
    public void testGetClient() {
        ...
        callback = (ResultCallback<Long>) (Future<Long> result) -> {
            Long time = null;
            try {
        ...
        callback = (ResultCallback<String>) (Future<String> result) -> {
            String echo = null;
            try {
        ...
        client.echo(msg2, (ResultCallback<String>) (Future<String> result) -> {
            String echo = null;
            try {
                echo = result.get(waitSeconds, TimeUnit.SECONDS);
            } catch (InterruptedException | ExecutionException | TimeoutException ex) {
    ...
    public void testGetClient_complex() {
        ...
        client.getProtocol(99, msg, Collections.EMPTY_LIST, (ResultCallback<Protocol<String>>) (Future<Protocol<String>> result) -> {
    ...
    public void testGetClient_not_found() {
        DemoClientInterface client = webSocketClientActionFactory.getClient(DemoClientInterface.class);
        ResultCallback<RpcException> callback = (Future<RpcException> result) -> {
    ...
    public void testGetClient_exception() {
        ...
        client.exception(msg, (ResultCallback<RpcException>) (Future<RpcException> result) -> {
    ...
    public void testGetClient_sleep() {
        DemoClientInterface client = webSocketClientActionFactory.getClient(DemoClientInterface.class);
        //sleep 3s
        client.sleep(3000, (ResultCallback<Void>) (Future<Void> result) -> {
            try {
                //wait 1s timeout
        ...
        //sleep 1.5
        client.sleep(1500, (ResultCallback<Void>) (Future<Void> result) -> {
            try {
                //wait 5s timeout
