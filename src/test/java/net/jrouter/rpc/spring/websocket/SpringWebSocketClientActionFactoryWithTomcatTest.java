...
import net.jrouter.rpc.spring.websocket.config.SpringWebSocketClientActionFactoryConfiguration;
import net.jrouter.rpc.spring.websocket.config.SpringWebSocketServerActionFactoryConfiguration;
...
public class SpringWebSocketClientActionFactoryWithTomcatTest extends TomcatBaseTest {
    ...
    public void testGetClient() {
        ...
        ResultCallback<String> callback = (Future<String> result) -> {
            String echo = null;
            try {
    ...
    public void testGetClient_complex() {
        ...
        demoClientInterface2.getProtocol(99, msg, Arrays.asList("aab", msg), (ResultCallback<Protocol<String>>) (Future<Protocol<String>> result) -> {
