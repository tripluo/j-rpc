...
import static jrouter.rpc.TomcatBaseTest.*;
import jrouter.rpc.router.client.websocket.DemoClientEndpoint;
import jrouter.rpc.router.client.websocket.util.SessionPooledObjectFactory;
import jrouter.rpc.spring.websocket.SpringDemoServerEndpoint;
import jrouter.rpc.spring.websocket.SpringWebSocketClientActionFactory;
...
public class SpringWebSocketClientActionFactoryConfiguration {
    ...
    static SpringWebSocketClientActionFactory springWebSocketClientActionFactory(DemoClientEndpoint demoClientEndpoint,
        ...
        SpringWebSocketClientActionFactory factory = new SpringWebSocketClientActionFactory(sessionPool, Collections.EMPTY_MAP);
        //add client interfaces
        factory.setClientInterfaces(Arrays.asList(jrouter.rpc.DemoClientInterface2.class));
